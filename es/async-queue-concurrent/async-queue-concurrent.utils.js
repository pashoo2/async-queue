...
var createJobPromise = function (promisePendingRejectableCreator) { return promisePendingRejectableCreator(); };
exports.createJobPromise = createJobPromise;
var wrapAllMethodsWithAsyncQueue = function (target, asyncQueueCreator, methodsNamesList) {
    var e_1, _a;
    var prototype = __assign({}, target.prototype);
        ...
        descriptor.value = function () {
            ...
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, asyncQueueCreator(this).wait()];
                        case 1:
                            job = _a.sent();
                            try {
    ...
    try {
        for (var _b = __values(Object.keys(prototype)), _c = _b.next(); !_c.done; _c = _b.next()) {
