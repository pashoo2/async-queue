...
var async_queue_concurrent_with_auto_execution_1 = require("../../async-queue-concurrent-extended/async-queue-concurrent-with-auto-execution/async-queue-concurrent-with-auto-execution");
function asyncQueueConcurrentMixinDefault(BaseClass, jobTimeoutDefault) {
    var Mixin = /** @class */ (function (_super) {
        ...
        Mixin.prototype._runAsJob = function (func, jobName, jobTimeout) {
            if (jobTimeout === void 0) { jobTimeout = jobTimeoutDefault; }
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, this._getAsyncOperationsQueue().executeQueued(func, jobTimeout, jobName)];
                        case 1: return [2 /*return*/, _a.sent()];
                    }
                });
            });
        };
        Mixin.prototype._rejectAllPendingOperations = function (err) {
            return this._getAsyncOperationsQueue().destroy(err);
        };
        Mixin.prototype._initializeAsyncQueue = function () {
        ...
        Mixin.prototype._getAsyncOperationsQueue = function () {
